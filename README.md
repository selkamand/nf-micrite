...
2. [micrite-sleuth] for slower but exhaustive *in silico* validation that a specific species of interest (e.g. those flagged by micrite-screen) is indeed present and not just misclassified host-sequences.
3. [micrite-subtype] for deep genotyping of common oncoviruses (*in-development*).
